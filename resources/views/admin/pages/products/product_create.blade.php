        ...
        <div class="card card-flush p-10">
            <form id="kt_docs_formvalidation_text" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <select id="parent-category-dropdown" class="form-control form-control-solid mb-3 mb-lg-0"
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <select id="category-dropdown" name="category_id" class="form-control form-control-solid mb-3 mb-lg-0">
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <select id="sub-category-dropdown" class="form-control form-control-solid mb-3 mb-lg-0"
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <select class="form-control form-control-solid mb-3 mb-lg-0"
                                name="sub_category_item_id" id="sub-category-item-dropdown">
                            <option value="">--Sub Category Item--</option>
...
{{--                            @endforeach--}}
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" id="editor2" name="description" value="{{old('description')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" id="editor3" name="definition" value="{{old('definition')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="ref_number" value="{{old('ref_number')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="bulk" value="{{old('bulk')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="bulk_part" value="{{old('bulk_part')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="testing" value="{{old('testing')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="latex_material" value="{{old('latex_material')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="sterility" value="{{old('sterility')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="ce_marking" value="{{old('ce_marking')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="intended_use" value="{{old('intended_use')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
                ...
                <div class="fv-row mb-10 row fv-plugins-icon-container">
                    ...
                    <div class="col-7">
                        <input type="text" name="available_in" value="{{old('available_in')}}"
                               class="form-control form-control-solid mb-3 mb-lg-0">
                        <div class="fv-plugins-message-container invalid-feedback">
                        </div>
                    </div>
