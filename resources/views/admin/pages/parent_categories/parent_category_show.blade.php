        ...
        <div class="content-header row mb-6">
            <div class="content-header-left col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-4">Main Categories</h2>
        ...
        <div class="card card-body p-10">
            <div class="d-flex flex-stack mb-5 ">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    <a href="{{route('parent_categories.create')}}" class="btn btn-primary btn-sm">
                        ...
                        @foreach($parentCategories as $parentCategory)
                            <tr class="even">
                                ...
                                <td style="width:100px;">
                                    <div class="text-end">
                                        <div>
                                            <a href="{{route('parent_categories.edit', ['parent_category'=> $parentCategory->id])}}"
                                               class="btn btn-success px-4 btn-sm kt_modal_stacked_edit">
                                                <i class="bi bi-pencil p-0"></i>
                                            </a>
                                            <form action="{{ route('parent_categories.destroy', ['parent_category' => $parentCategory->id]) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
