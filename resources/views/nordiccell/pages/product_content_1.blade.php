                        ...
                        @else
                            @if(auth()->user())
                                <form class="cart" action="{{route('add_cart',['product' => $product->id])}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" name="add-to-cart" value="3505" class="single_add_to_cart_button button alt">Add to cart<img class="add-to-cart-button-icon-small" src="https://nordiccell.com/wp-content/themes/nordiccell/assets/dist/icons/cart-white.svg"></button>
